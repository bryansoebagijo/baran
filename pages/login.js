    ...
    return (
            <div className="login">
                ...
                <div className="container login-content">
                    ...
                    {error?<div className='d-flex justify-content-center align-items-center mt-3' style={{ "width": "100%", "background" : "#ff6e6b" ,"color":"#cf0a06", "borderRadius": "10px", "boxShadow" : "5px 10px 20px rgba(0, 0, 0, 0.25)", "font-size" : "calc(1.2vw + 1.2vh)"}}>{error}</div>:''}
