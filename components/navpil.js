                ...
                <div className="navpill">
                    <ul className="nav nav-pills">
                        <li className="nav-item">
                            <a className={time =='today'? "nav-link active":"nav-link"} onClick={()=>handlerTime('today')}>today</a>
                        </li>
                        <li className="nav-item">
                            <a className={time =='yesterday'? "nav-link active":"nav-link"} onClick={()=>handlerTime('yesterday')}>Yesterday</a>
                        </li>
                        <li className="nav-item">
                            <a className={time =='weekly'? "nav-link active":"nav-link"} onClick={()=>handlerTime('weekly')}>Weekly</a>
                        </li>
                    </ul>
                </div>
            </div>
